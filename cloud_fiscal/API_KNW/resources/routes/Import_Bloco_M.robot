...
POST M110
    ...
    ${response}     POST       ${API_USERS2}/blocoM/M110       json=${payload}       expected_status=any

    ...                          data={"objetos":[{"knwM110":{"cod_EMPRESA":0,"cod_FILIAL":0,"id_USUARIO_IMP":"string","dt_IMPORTACAO":"2022-06-20T20:04:33.214Z","aliq_PIS":0,"dt_REFERENCIA":"2022-06-20T20:04:33.214Z","cd_436":"string","dm_AJUSTE":"string","vl_AJUSTE":0,"cd_438":"string","ds_AJUSTE":"string","dt_AJUSTE":"2022-06-20T20:04:33.214Z","nr_PROCESSO":"string","vl_ALIQ_PIS":0}}]}
    ...                          headers=${ headers }
...
POST M410
    ...
    ${response}     POST       ${API_USERS2}/blocoM/M410       json=${payload}       expected_status=any
...
POST M510 
    ...
    ${response}     POST       ${API_USERS2}/blocoM/M510       json=${payload}       expected_status=any
...
POST M810 
    ...
    ${response}     POST       ${API_USERS2}/blocoM/M810       json=${payload}       expected_status=any
