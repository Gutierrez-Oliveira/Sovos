...
POST Import Pessoas
    ...
    ${response}     POST       ${API_USERS2}/pessoas             json=${payload}       expected_status=any
...
POST Import Producao Usina
    ...
    ${response}     POST       ${API_USERS2}/producaoUsina       json=${payload}       expected_status=any
...
POST Import Produto Servico
    ...
    ${response}     POST       ${API_USERS2}/produtoServico       json=${payload}       expected_status=any
...
POST Import Valores Agregados
    ...
    ${response}     POST       ${API_USERS2}/valoresAgregados       json=${payload}       expected_status=any
